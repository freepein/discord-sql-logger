...
-- Generated At: 10/25/2020 21:53:48 +00:00
-- --------------------------------------------------------------
...
CREATE TABLE `logged_messages` (
  `guild` varchar(101) DEFAULT NULL,
  `time_stamp` date DEFAULT NULL,
  `discord_username` varchar(37) DEFAULT NULL,
  `discord_id` varchar(19) DEFAULT NULL,
  `discord_message` varchar(2001) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

LOCK TABLES logged_messages WRITE;
UNLOCK TABLES;
